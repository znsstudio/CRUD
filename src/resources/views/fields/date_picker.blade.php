...
@if ($crud->checkIfFieldIsFirstOfItsType($field, $fields))
    ...
    @if (isset($field['date_picker_options']) && isset($field['date_picker_options']['language']) && $field['date_picker_options']['language'] !== 'en')
    <script charset="UTF-8" src="/vendor/adminlte/plugins/datepicker/locales/bootstrap-datepicker.{{$field['date_picker_options']['language']}}.js"></script>
    @endif
    <script>
        ...
        jQuery(document).ready(function($){
            $('[data-bs-datepicker]').each(function(){
                ...
                preparedDate = new Date($field.val()).format($fake.data('bg-datepicker-format'));
