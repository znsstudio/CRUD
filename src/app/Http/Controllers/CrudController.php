...
class CrudController extends BaseController
{
     ...
     */
     ...
     {
        $response = ['success' => false, 'message' => 'unknown error', 'meta' => ['link' => null, 'snippet' => null, 'entity_key' => null]];
        ...
        if (empty($field_name)) {
            $response['message'] = 'field_name is missing';
            ...
            if (! $existing_entity ) {
                ...
                $response['message'] = $this->crud->entity_name.' already exists';
                $response['meta'] = [
